    ...
    <>
      <h2
        className={`text-xl font-bold ${
          selectedComplaint.emergency ? "text-red-800" : "text-green-800"
        }`}
      >
      ...
      <p>
        <strong>Created On:</strong> {dateFormat(selectedComplaint.createdAt)}
      </p>
      <p>
      ...
      <div className="grid grid-cols-2 gap-4 mt-3">
        {selectedComplaint.media.imgBefore && (
          <button
            ...
            onClick={() => handleMediaOpen(selectedComplaint.media.imgBefore)}
          >
            Image Before
          </button>
        )}
        {selectedComplaint.media.vidBefore && (
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600"
            onClick={() => handleMediaOpen(selectedComplaint.media.vidBefore)}
          >
            Video Before
          </button>
        )}
        {selectedComplaint.media.imgAfter && (
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600"
            onClick={() => handleMediaOpen(selectedComplaint.media.imgAfter)}
          >
            Image After
          </button>
        )}
        {selectedComplaint.media.vidAfter && (
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600"
            onClick={() => handleMediaOpen(selectedComplaint.media.vidAfter)}
          >
            Video After
          </button>
        )}
